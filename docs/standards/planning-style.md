...
- Keep human-edited working roadmap definitions in `planning/oss-vision/roadmaps/master-roadmap.md`. Per-project files under `planning/<project>/roadmaps/generated/` are generated projection views. Historical hardcopies belong under `_legacy/`; do not hand-maintain milestone definitions there.
